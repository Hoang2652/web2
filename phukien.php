...
<div id="content">
	...
	<div class="product-wrapper">
		...
		<div class="product-info">
			<?php
		$sql="select * from danhmuc where loaidanhmuc='LSP' AND iddanhmuc != '8' order by iddanhmuc";
		$result=mysqli_query($link,$sql);
			...
			<?php 
				$sql1="select * from sanpham where loaisanpham={$row['iddanhmuc']} AND trangthai='1' order by idsanpham LIMIT 0,4";
