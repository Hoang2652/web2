...
<div class="quanlysp">
    ...
    <p style="text-align:right; margin-right: 100px;">Có tổng cộng: <font color=red><b><?php echo $dem ?></b></font> hóa đơn</p>
    <div class="form-row">
        ...
        <div class="col-md-8 form-row">
            ...
            <div class="col-md-3 mb-3">
                ...
                <div style="border: none;width: 280px;">
                    <button class="btn btn-primary" type="submit" name="giaohang" value="Đã giao hàng" >Đã giao hàng</button>
                    <button class="btn btn-danger" type="submit" name="huy" value="Hủy đơn hàng" >Hủy đơn hàng</button>
                </div>
            </div>
        </div>
    </div>
